// Cosmic Portal Main JavaScript - UPDATED
class CosmicPortal {
    constructor() {
        this.init();
    }
    ...
    init() {
        setTimeout(() => {
            ...
            this.addMovableOm(); // Purana movable Om add karein
        }, 2000);
    }
    ...
    showOmExperience() {
        ...
        if (omExperience) {
            ...
            // Naye Cosmic Om par click event
    ...
    activatePortal() {
        ...
        cosmicOmButton.style.transform = 'translate(-50%, -50%) scale(3)';
    ...
    addMovableOm() {
        // Purana movable Om create karein
